...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2021 at 06:52 PM
...
--
-- Table structure for table `blood_analytical_service`
--
...
--
-- Dumping data for table `blood_analytical_service`
--
...
CREATE TABLE `booking` (
  ...
  `booked_for` enum('Self','Father','Mother','Brother','Sister','Relative','Friend','Stranger') DEFAULT NULL,
...
INSERT INTO `booking` (`id`, `booked_at`, `mobile_no`, `name`, `sex`, `bed_type`, `booked_for`, `cancelled_at`, `registration_no`, `status`, `remarks`, `last_updated`) VALUES
('06fhm22ue8', '2017-08-12 13:22:04', '+8801165675284', 'Emily Matthews', 'T', 'HDU', 'Brother', NULL, '7722788763', 'Served', 'Tony bought new car. Anne bought new car. John bought new car. Tony is shopping. John bought new car. ', '2015-10-13 19:09:35'),
('0kt66bxim1', '2015-03-28 20:38:01', '+8801593470482', 'Erich Ingram', 'F', 'VIP Cabin', NULL, NULL, '7503214296', 'Served', 'Tony is shopping. Tony is shopping. Tony has free time. Tony has free time. Tony is walking. ', '2017-05-25 02:42:09'),
('0x1pvj475y', '2018-03-16 16:59:34', '+8801563376983', 'Kendall Ryan', 'F', 'ICU', 'Sister', NULL, '2836314655', 'Booked', 'Tony bought new car. Anne bought new car. Anne has free time. ', '2017-02-14 04:07:12'),
('2662b2tphq', '2015-01-12 19:55:51', '+8801870206523', 'Charlotte Lara', 'M', 'Cabin', 'Friend', '2018-12-06 19:14:20', '3613266758', 'Booked', 'Tony bought new car. Anne is walking. John is walking. ', '2018-05-07 06:56:42'),
('27e39k7e6w', '2016-01-12 13:40:01', '+8801563376983', 'Audrey Beltran', 'M', 'Ward', 'Brother', NULL, '3613266758', 'Booked', 'Tony has free time. Anne is walking. Anne has free time. ', '2017-01-28 22:46:42'),
('286x6m73u1', '2020-08-10 13:37:27', '+8801870206523', 'Manuel Mcfarland', 'F', 'HFNCU', 'Relative', NULL, '0476608341', 'Served', 'Anne bought new car. Anne is walking. ', '2015-06-25 08:06:28'),
('2e66se97zx', '2015-12-02 17:44:44', '+8801165675284', NULL, 'M', 'HFNCU', 'Mother', NULL, '2836314655', 'Cancelled', 'John bought new car. Tony bought new car. Tony bought new car. ', '2016-12-03 05:01:28'),
('2rh1o2y7nq', '2015-02-26 01:07:31', '+8801636637722', 'Abraham Gates', 'M', 'Ward', 'Father', NULL, '7503214296', 'Booked', 'John is shopping. Tony has free time. ', '2019-06-18 23:39:06'),
('3360ao2h0y', '2015-08-30 06:53:59', '+8801596047660', 'Abraham Blackburn', 'T', 'Emergency', 'Relative', NULL, '0476608341', 'Booked', 'John bought new car. Tony has free time. Anne bought new car. John is walking. Tony has free time. ', '2019-04-16 07:10:29'),
('35f29ttm51', '2015-01-15 10:56:09', '+8801836314655', NULL, 'T', 'Ward', 'Relative', NULL, '7531726902', 'Cancelled', 'Tony bought new car. John bought new car. Anne has free time. Anne has free time. Tony is shopping. ', '2015-04-06 02:58:07'),
('37010mjsq3', '2019-05-03 16:00:07', '+8801165675284', NULL, 'S', 'Extra', 'Brother', NULL, '6895047952', 'Cancelled', 'Anne bought new car. John is shopping. John has free time. ', '2020-06-17 12:54:29'),
('37q37v5t21', '2018-05-02 08:04:44', '+8801125816591', 'Ramona Hess', 'M', 'HDU', 'Mother', NULL, '3613266758', 'Served', 'Tony bought new car. Tony is shopping. John has free time. Tony bought new car. John bought new car. ', '2017-06-08 14:33:43'),
('3865ru5g84', '2020-09-08 22:03:16', '+8801596047660', 'Randall Morrison', 'M', 'HDU', 'Relative', NULL, '0476608341', 'Booked', 'Anne has free time. John bought new car. Tony is walking. ', '2015-04-04 19:58:43'),
('40th24fpwd', '2021-01-05 21:59:58', '+8801422081583', 'Damien Newman', 'S', 'Emergency', 'Relative', NULL, '7503214296', 'Cancelled', 'Anne bought new car. Tony is walking. John has free time. Anne has free time. John has free time. ', '2018-02-13 20:41:51'),
('56lx6183um', '2015-04-12 10:26:37', '+8801636637722', 'Chester Hutchinson', 'F', 'Ward', 'Stranger', NULL, '3875193242', 'Cancelled', 'Anne bought new car. Tony has free time. Tony bought new car. John is walking. Anne has free time. ', '2019-09-03 20:33:47'),
('5wur4m4420', '2019-11-24 06:55:42', '+8801836314655', 'Tracey Mcgrath', 'M', 'COVID', NULL, NULL, '7722788763', 'Cancelled', 'Anne bought new car. Anne is walking. Tony is shopping. Tony bought new car. Tony is shopping. ', '2016-10-28 08:33:30'),
('627gndp34v', '2019-05-06 03:10:07', '+8801836314655', NULL, 'T', 'Extra', 'Brother', NULL, '3875193242', 'Cancelled', 'Anne bought new car. Tony has free time. ', '2020-12-14 21:10:10'),
('652i2441d6', '2018-08-24 17:45:11', '+8801197745135', 'Shelley Garrett', 'F', 'HDU', 'Father', NULL, '3875193242', 'Booked', 'Anne is shopping. Tony bought new car. John is walking. ', '2020-11-21 09:26:13'),
('65ye9uvyo6', '2017-04-15 04:24:00', '+8801636637722', 'Owen George', 'S', 'Extra', NULL, NULL, '3613266758', 'Cancelled', 'Anne bought new car. Anne has free time. ', '2018-12-15 19:28:25'),
('6sgqd1113p', '2017-06-27 22:44:37', '+8801123422718', 'Esmeralda Mejia', 'M', 'HFNCU', 'Brother', NULL, '7503214296', 'Cancelled', 'John has free time. Anne is walking. Tony bought new car. John is shopping. Tony has free time. ', '2016-02-05 02:10:09'),
('73uhj9ap25', '2016-01-18 19:15:16', '+8801169023360', 'Jim Hoffman', 'S', 'ICU', 'Brother', NULL, '2836314655', 'Cancelled', 'Tony bought new car. John is walking. Tony bought new car. Tony has free time. Tony has free time. ', '2020-06-12 00:55:49'),
('7p82ol1lbj', '2017-06-05 19:58:13', '+8801603376378', 'Tonya Combs', 'F', 'Special Ward', 'Sister', NULL, '3701043663', 'Cancelled', 'Anne is shopping. Anne has free time. John is shopping. ', '2017-02-10 06:24:13'),
('7s2278v76i', '2021-05-15 05:38:36', '+8801593470482', NULL, 'F', 'HFNCU', 'Brother', NULL, '3875193242', 'Served', 'John bought new car. Anne is walking. ', '2016-02-19 01:56:40'),
('7sy7s29w8a', '2021-03-26 19:21:19', '+8801562388006', 'Otis Rodgers', 'M', 'Ward', 'Father', NULL, '6895047952', 'Cancelled', 'Tony bought new car. John is shopping. ', '2017-02-17 12:00:17'),
('8388ro4d22', '2021-03-02 11:53:21', '+8801968950479', 'Roxanne Ellison', 'M', 'ICU', 'Relative', NULL, '0476608341', 'Cancelled', 'Anne is shopping. Anne is walking. Anne bought new car. Anne bought new car. ', '2020-06-22 00:41:48'),
('bp2jq3j76y', '2020-12-29 16:11:49', '+8801870206523', 'Rose Moreno', 'S', 'VIP Cabin', 'Father', '2015-09-20 12:39:44', '7503214296', 'Cancelled', 'Anne has free time. Anne bought new car. John is walking. Anne has free time. Tony bought new car. ', '2016-06-05 19:14:26'),
('cp8c776bv3', '2017-12-18 01:48:04', '+8801126675875', 'Darren Sanford', 'M', 'Cabin', 'Mother', NULL, '7531726902', 'Booked', 'John is shopping. John is shopping. Anne bought new car. Tony is walking. Anne has free time. ', '2015-02-18 05:46:36'),
('d218274k38', '2016-12-07 15:54:51', '+8801593470482', 'Dwight Hayes', 'M', 'VIP Cabin', 'Stranger', NULL, '3360052309', 'Booked', 'Anne bought new car. John bought new car. John bought new car. Tony bought new car. Tony bought new car. ', '2016-01-27 15:44:54'),
('em76j1fo7a', '2015-10-06 12:50:03', '+8801173733906', 'Dena Mack', 'S', 'ICU', 'Relative', NULL, '7503214296', 'Booked', 'John has free time. John is walking. Tony has free time. John is shopping. Anne bought new car. ', '2018-03-10 10:15:52'),
('fxhq31msoo', '2017-03-10 14:26:27', '+8801836314655', 'Dominick Neal', 'M', 'Cabin', 'Stranger', NULL, '3613266758', 'Served', 'Tony bought new car. Anne has free time. Tony has free time. John has free time. Tony has free time. ', '2015-02-27 14:42:19'),
('g84i52yil1', '2018-06-11 08:48:18', '+8801126675875', 'Clyde Flowers', 'M', 'Emergency', 'Relative', NULL, '3701043663', 'Served', 'Tony bought new car. John bought new car. John has free time. John has free time. Anne bought new car. ', '2016-07-30 07:40:46'),
('h63i565e3f', '2020-01-05 19:34:44', '+8801127433875', 'Marlon Newton', 'F', 'ICU', 'Mother', NULL, '3701043663', 'Cancelled', 'Tony has free time. John is shopping. Tony has free time. John has free time. Tony is walking. ', '2018-09-12 15:59:58'),
('i551t23j62', '2016-01-02 22:16:01', '+8801123422718', 'Ebony Daniels', 'F', 'Special Ward', 'Mother', '2015-10-17 23:59:04', '6895047952', 'Cancelled', 'Anne is walking. Anne has free time. John bought new car. ', '2018-04-25 19:43:32'),
('i8toe9i2mf', '2019-09-05 08:50:07', '+8801968950479', 'Cherie White', 'S', 'Emergency', 'Relative', NULL, '7722788763', 'Served', 'Anne is shopping. Tony is walking. John is shopping. Tony bought new car. Tony has free time. ', '2016-09-18 14:17:21'),
('irc326675x', '2017-09-06 05:38:41', '+8801165675284', 'Charlotte Byrd', 'M', 'Ward', 'Brother', NULL, '3701043663', 'Cancelled', 'Tony is shopping. Tony is shopping. ', '2016-04-13 20:29:39'),
('j225o7gym4', '2018-11-03 03:10:56', '+8801538751932', 'Clarissa Dunlap', 'M', 'ICU', 'Friend', NULL, '7531726902', 'Cancelled', 'Anne bought new car. John bought new car. John is walking. Tony has free time. Anne has free time. ', '2019-03-27 19:36:34'),
('jvvab6pbk8', '2021-05-05 11:54:43', '+8801870206523', 'Arthur Barrera', 'M', 'HFNCU', 'Brother', NULL, '3701043663', 'Booked', 'Anne bought new car. Anne is walking. John is shopping. ', '2017-08-10 19:52:55'),
('oa6e6b7m26', '2020-01-27 02:50:13', '+8801603376378', 'Derrick Huffman', 'M', 'Ward', 'Mother', NULL, '6895047952', 'Cancelled', 'Anne bought new car. Tony is shopping. Tony has free time. John has free time. ', '2018-08-22 22:06:44'),
('q5b53u7bgb', '2021-03-09 04:28:14', '+8801125816591', 'Lara Haynes', 'S', 'ICU', NULL, NULL, '2836314655', 'Booked', 'Anne bought new car. Anne has free time. Anne bought new car. John has free time. Tony has free time. ', '2019-01-08 09:48:25'),
('qml2w3hg47', '2019-07-29 09:43:00', '+8801563376983', 'Sharon O\'Neal', 'T', 'Ward', 'Friend', NULL, '2836314655', 'Served', 'John is walking. Anne has free time. Tony is shopping. John has free time. Anne has free time. ', '2020-07-10 01:05:51'),
('r53r4d7u6s', '2020-10-14 11:57:24', '+8801126675875', 'Bobbi Larson', 'M', 'Emergency', 'Relative', '2017-11-26 10:29:31', '7503214296', 'Cancelled', 'John bought new car. Anne is walking. Tony is walking. John is walking. John has free time. ', '2016-10-07 15:08:32'),
('r8zoaksz52', '2017-09-12 14:01:14', '+8801968950479', NULL, 'S', 'HFNCU', 'Mother', NULL, '3875193242', 'Served', 'Anne bought new car. John is walking. John bought new car. John has free time. ', '2017-07-25 11:52:52'),
('riyik7b48g', '2016-01-19 09:00:49', '+8801538751932', 'Debra Middleton', 'S', 'Cabin', 'Brother', NULL, '0476608341', 'Cancelled', 'John has free time. Anne has free time. Tony is shopping. Tony is shopping. Anne has free time. ', '2017-08-19 16:03:50'),
('sfcfp342qq', '2019-02-08 18:43:12', '+8801169023360', 'Stephan Park', 'S', 'Special Ward', NULL, NULL, '3613266758', 'Booked', 'Anne bought new car. Anne has free time. Tony bought new car. Tony has free time. John has free time. ', '2016-09-01 15:55:39'),
('tnb32c4gyr', '2016-05-14 02:18:48', '+8801123422718', 'Lynn Miles', 'F', 'Special Ward', 'Relative', NULL, '7503214296', 'Booked', 'Anne is shopping. Anne bought new car. Tony bought new car. John is shopping. John has free time. ', '2018-10-11 14:42:13'),
('tt82283776', '2018-07-20 03:07:21', '+8801968950479', 'Randal Patterson', 'M', 'Special Ward', NULL, NULL, '7722788763', 'Booked', 'Anne bought new car. Anne is shopping. John bought new car. ', '2019-04-26 19:47:52'),
('v30f74i036', '2015-01-12 09:58:18', '+8801563376983', 'Deanna Hicks', 'M', 'ICU', 'Mother', NULL, '0476608341', 'Cancelled', 'John bought new car. Tony bought new car. ', '2019-12-20 11:56:31'),
('v5idu26zbe', '2019-10-23 18:44:52', '+8801562388006', 'Stephen Cisneros', 'M', 'ICU', 'Brother', NULL, '7531726902', 'Cancelled', 'Anne bought new car. Anne is walking. John bought new car. ', '2019-05-20 15:45:48'),
('w8k36lpm2s', '2020-04-19 12:25:13', '+8801593470482', 'Tammy Fletcher', 'M', 'ICU', 'Father', NULL, '3701043663', 'Served', 'John bought new car. Anne has free time. John bought new car. ', '2019-04-13 01:53:08'),
('x5c7b429n2', '2019-08-22 14:15:06', '+8801176877298', 'Joyce Carlson', 'M', 'VIP Cabin', 'Stranger', NULL, '3875193242', 'Cancelled', 'Anne has free time. John is walking. Tony bought new car. John has free time. Anne is walking. ', '2020-02-24 23:45:10');
...
CREATE TABLE `capacity` (
  `registration_no` char(10) NOT NULL,
  `total_capacity` mediumint(6) NOT NULL,
  `ward` smallint(6) DEFAULT NULL,
  `special_ward` smallint(6) DEFAULT NULL,
  `cabin` tinyint(4) DEFAULT NULL,
  `vip_cabin` tinyint(4) DEFAULT NULL,
  `icu` tinyint(4) DEFAULT NULL,
  `ccu` tinyint(4) DEFAULT NULL,
  `hdu` smallint(6) DEFAULT NULL,
  `hfncu` smallint(6) DEFAULT NULL,
  `emergency` smallint(6) DEFAULT NULL,
  `covid` smallint(6) DEFAULT NULL,
...
--
-- Table structure for table `diagnostic_imaging_service`
--
...
--
-- Dumping data for table `diagnostic_imaging_service`
--
...
('+8801123947168', '4GA1NXH512T780774', 'Martha Mora', 'wctq7@odoozekrnxtfj.net', 'Admin', 'Inactive', '7722788763', '2020-01-05 12:50:49', '2014-05-15 16:06:23'),
('+8801125707782', '3GANSIF717L856815', 'Troy Kaufman', 'qyqv8@jictvnrixv.org', 'Moderator', 'Active', '3360052309', '2011-04-28 16:24:24', '2013-08-11 06:00:54'),
('+8801125816591', 'WGXNRJ4B15M504766', 'Tonya Shelton', 'vner98@ykfcur.com', 'Moderator', 'Active', '3875193242', '2019-11-22 13:31:01', '2016-09-16 14:56:03'),
('+8801125828005', 'WJXT0M4I16J448238', 'Ben Cruz', 'xaadfb@jlibnp.org', 'DB Manager', 'Inactive', '3701043663', '2018-01-07 06:37:40', '2013-01-13 10:11:33'),
('+8801126620275', 'WWA2P77314L625434', 'Marlene Mack', 'iamuhn7@moflijhxhm.com', 'Moderator', 'Inactive', '3875193242', '2016-07-10 19:49:48', '2018-07-02 15:19:30'),
('+8801126675875', 'WFA43LN513H888817', 'Alfredo Yates', 'tmtd.uixaoqu@umcrlk.com', 'Moderator', 'Inactive', '6895047952', '2020-07-15 20:17:00', '2017-03-01 19:43:41'),
('+8801127787165', 'WKSBFDTW11J799073', 'Omar Merritt', 'lqxc7@gdsrmxxksapc.net', 'Moderator', 'Active', '7531726902', '2017-08-25 12:22:50', '2016-09-07 12:49:03'),
('+8801129522415', 'WNSV721V10J130412', 'Debra Hale', 'qpnhv484@nnbblrskuand.org', 'DB Manager', 'Active', '7531726902', '2014-07-16 01:41:33', '2011-12-14 02:34:53'),
('+8801131522914', 'WRSC0K4B15Y325207', 'Tracy Odom', 'kywe6@vboujmxfukvk.com', 'Moderator', 'Inactive', '3701043663', '2017-04-11 23:22:10', '2020-12-19 22:59:17'),
('+8801148564861', 'WDX6J9S515K965371', 'Cheryl Johns', 'jhvsk5@pjghxk.com', 'Admin', 'Inactive', '7503214296', '2019-04-23 17:37:06', '2018-03-21 15:31:48'),
('+8801150616074', '4XS33C4718T829554', 'Rodney Burton', 'nwev.mdyc@kiuiyuhmli.org', 'Moderator', 'Inactive', '0476608341', '2012-03-04 07:25:45', '2012-04-01 20:28:46'),
('+8801152326726', '2TAY35X514S154978', 'Aimee Sampson', 'oookp6@pysduxsolf.org', 'Admin', 'Inactive', '3360052309', '2014-12-29 20:40:28', '2011-03-01 08:27:44'),
('+8801156807737', '3JXSD24U12I315991', 'Susan Petersen', 'hxgf.paat@drdhdolsks.org', 'Moderator', 'Inactive', '3613266758', '2020-01-03 19:17:43', '2011-04-28 10:31:31'),
('+8801157294462', '2NS185I716X208245', 'Joni Shaffer', 'eexj@kdxflj.com', 'Moderator', 'Active', '3360052309', '2018-04-26 23:57:03', '2020-01-25 22:21:52'),
('+8801161979865', 'WVAU6Y1515S619418', 'Cara Carney', 'ynbi.xcmle@fjuwkb.com', 'Moderator', 'Inactive', '3613266758', '2013-11-29 12:42:33', '2020-05-11 01:51:29'),
('+8801165675284', '2RXYJSW314K095542', 'Rodolfo Turner', 'pbfo.uldo@xwrtqc.net', 'DB Manager', 'Active', '6895047952', '2016-11-10 00:22:29', '2017-11-13 06:31:41'),
('+8801169023360', 'WUAO8JC418S501454', 'Devon Vasquez', 'epyv4@jvmsii.com', 'Moderator', 'Active', '7531726902', '2018-09-26 15:11:24', '2018-07-17 23:41:47'),
('+8801173733906', '4RSY3E6511M733827', 'James Cobb', 'mlfy7@ibwfteriwptl.com', 'DB Manager', 'Inactive', '0476608341', '2018-11-12 01:18:24', '2015-05-16 19:00:09'),
('+8801176877298', '4CA01Q6214A354802', 'Frances Curry', 'dlmg261@wczzfdymnl.org', 'Admin', 'Inactive', '7503214296', '2015-10-17 00:55:42', '2015-09-03 20:49:37'),
('+8801183538447', 'WQS5555018T046953', 'Victoria Gross', 'ptod24@vhgmnvbfeov.org', 'Admin', 'Inactive', '3701043663', '2013-06-02 13:46:56', '2019-06-08 10:45:17'),
('+8801197745135', 'WCSBL5C219X531750', 'Tia Townsend', 'oirq6@gbvpjv.net', 'Admin', 'Active', '2836314655', '2011-05-09 09:32:46', '2015-09-01 17:41:26'),
('+8801366873365', '3UA1D88A13Z737756', 'Jared Villegas', 'lcse8@dfuvrl.net', 'Moderator', 'Active', '3875193242', '2012-08-14 19:31:08', '2011-07-19 18:46:51'),
('+8801394445316', '5KXUG11815A710454', 'Debra Olsen', 'gfjuo.asusi@ahcgdqbccbf.com', 'Admin', 'Inactive', '3613266758', '2012-10-24 20:36:22', '2013-01-13 20:33:36'),
('+8801422081583', '2OXLOTGF10X356946', 'Darnell Reyes', 'jtxz@dfrbwo.com', 'Moderator', 'Inactive', '7503214296', '2016-07-02 08:39:50', '2021-03-06 13:36:02'),
('+8801453380268', '1FAH744714U952777', 'Roderick Cisneros', 'cdxrb83@dmpdbo.net', 'Admin', 'Active', '7531726902', '2021-03-14 07:25:54', '2013-05-20 13:03:34'),
('+8801538751932', 'WFSH41P513K211467', 'Tom Fowler', 'nwrs55@yyhdwnzlqt.net', 'Moderator', 'Inactive', '3360052309', '2021-06-07 03:56:41', '2019-05-09 21:21:01'),
('+8801541262152', 'WVA26U3615B410574', 'Brenda Bean', 'xynwu@fvrsmqhpkeg.org', 'Moderator', 'Active', '3701043663', '2018-02-17 23:07:33', '2016-11-13 14:04:53'),
('+8801562388006', '5TSW4L4C17W792979', 'Ramiro Ramsey', 'abwk3@sjtgdc.com', 'DB Manager', 'Inactive', '0476608341', '2020-01-26 12:49:40', '2021-08-30 13:17:31'),
('+8801563376983', 'WJAXWR3D14O451581', 'Kate Tate', 'heqc.luro@ursjjp.com', 'Admin', 'Active', '0476608341', '2013-05-31 13:55:30', '2011-02-19 23:37:15'),
('+8801593470482', '1KSP3S9T14K823810', 'Jodie Reeves', 'ihkbcc84@avpjtw.com', 'Moderator', 'Active', '7531726902', '2020-10-07 15:02:14', '2013-03-22 14:29:32'),
('+8801596047660', '5GS0KP3612H133913', 'Demond Chandler', 'lnvdr@jhcmlmshoqg.org', 'Moderator', 'Active', '6895047952', '2011-01-16 19:30:55', '2011-02-26 17:30:10'),
('+8801603376378', '12345', 'Vicki Meyer', 'iord@bowtkg.inc', 'DB Manager', 'Active', '0476608341', '2021-01-17 21:20:32', '2021-09-08 01:35:07'),
('+8801636637722', '3PA7612712J387117', 'Ron Joseph', 'fkvnzo9@uaxcqplutoknm.com', 'Moderator', 'Active', '3701043663', '2020-01-17 02:12:02', '2012-04-22 03:27:26'),
('+8801664268302', 'WES48B6513K748621', 'Kisha Browning', 'cnol@cyscwyxvetrqobf.org', 'Moderator', 'Active', '7531726902', '2014-09-23 17:34:46', '2015-04-07 13:01:30'),
('+8801676987367', '0842e8cde6cc91d2f8ef', 'Ali Aqbar', '7u4hf@wimsg.com', 'Moderator', 'Inactive', '0476608341', '2021-08-29 23:47:42', '2021-09-07 10:41:12'),
('+8801680242747', 'WNS068TF10A732797', 'Sheldon Donovan', 'yxmz.bwma@lpnjczdwemae.com', 'DB Manager', 'Active', '2836314655', '2017-02-28 05:35:07', '2017-06-14 01:55:45'),
('+8801689317455', 'WASEUCJB12L129752', 'Efrain Hall', 'zwcq95@eqtsdlcubxljcmx.com', 'Moderator', 'Inactive', '7503214296', '2011-07-10 17:24:30', '2018-01-24 03:54:48'),
('+8801714441372', '1KSK458518M213335', 'Bennie Mc Bride', 'lzxl8@hzcqgzbfxfa.net', 'Moderator', 'Active', '3360052309', '2016-01-14 10:19:20', '2012-07-19 20:40:44'),
('+8801716720550', '5IS31K6U19H532695', 'Trina Alexander', 'dexl78@iitgqr.com', 'Moderator', 'Inactive', '2836314655', '2019-06-07 12:31:05', '2020-03-01 11:57:09'),
('+8801762126342', '3SS665O314M881437', 'Michelle Hays', 'imbro.xomc@jewzjpdpcqx.com', 'Admin', 'Inactive', '3875193242', '2011-08-08 01:51:52', '2020-03-08 17:01:20'),
('+8801781250159', 'WKAJ34A117X106451', 'Sonny Frank', 'fzhf@mrdhcylrwn.com', 'DB Manager', 'Active', '6895047952', '2012-09-26 15:22:45', '2019-02-06 04:19:49'),
('+8801781776073', '3UX8R32P14I868224', 'Stacey Soto', 'bgmg92@itmrvombaq.com', 'Admin', 'Active', '3875193242', '2021-01-16 05:38:17', '2013-07-30 03:01:10'),
('+8801846494721', '1PSO3FWI10P285281', 'Willie Davis', 'oiuhrho2@fmnymp.net', 'Moderator', 'Inactive', '3613266758', '2013-07-09 21:20:10', '2020-10-29 10:17:48'),
('+8801867644283', 'WBS173BQ19L832433', 'Annie Lucas', 'zkoum.ckile@ovvtesrnmu.com', 'DB Manager', 'Inactive', '7503214296', '2015-04-27 18:31:26', '2012-01-15 03:45:50'),
('+8801870206523', '1SA78RZ911L920228', 'Tomas Logan', 'ulof41@txproncnlx.com', 'Admin', 'Inactive', '3701043663', '2021-06-13 03:09:00', '2018-05-26 18:14:19'),
('+8801876444420', '2XS9XNBY14V372002', 'Jerome Pierce', 'idvw@jkyzyf.com', 'DB Manager', 'Inactive', '7503214296', '2016-12-11 16:02:47', '2020-01-26 06:09:54'),
('+8801964737128', '5FSH8C6N14O730722', 'Juan Cisneros', 'fvma8@pyuoyw.com', 'Moderator', 'Active', '2836314655', '2021-07-07 08:22:20', '2016-08-28 05:57:06'),
('+8801968950479', '4KS871DI13J114342', 'Gabriel Luna', 'frcmm.ivmsmdp@siezjy.org', 'Admin', 'Inactive', '7503214296', '2014-02-07 15:36:19', '2021-02-28 05:53:05');
...
('+8801123422718', 'WMS8ET5T13R424293', 'Harry Brennan', 'S', '2001-01-21', 'ffmc@jpqaga.com', '78668689678315818', '2019-11-04 21:10:06'),
...
--
-- Table structure for table `vacant_bed_log`
--
...
--
-- Dumping data for table `vacant_bed_log`
--
...
--
-- Indexes for table `blood_analytical_service`
--
ALTER TABLE `blood_analytical_service`
  ADD PRIMARY KEY (`registration_no`);
...
ALTER TABLE `booking`
  ADD PRIMARY KEY (`id`),
  ADD KEY `booking_fk0` (`mobile_no`),
  ADD KEY `booking_fk1` (`registration_no`);
...
--
-- Indexes for table `diagnostic_imaging_service`
--
ALTER TABLE `diagnostic_imaging_service`
  ADD PRIMARY KEY (`registration_no`);
...
--
ALTER TABLE `doctor`
  ADD PRIMARY KEY (`id`,`registration_no`,`joined_on`),
  ADD KEY `doctor_fk0` (`registration_no`);
...
ALTER TABLE `hospital`
  ...
  ADD UNIQUE KEY `image_source` (`image_source`);

--
-- Indexes for table `log`
--
ALTER TABLE `log`
  ADD PRIMARY KEY (`logged_at`,`registration_no`),
  ADD KEY `log_fk0` (`registration_no`),
  ADD KEY `log_fk1` (`mobile_no`);
...
--
ALTER TABLE `staff`
  ADD PRIMARY KEY (`mobile_no`,`registration_no`,`joined_on`),
  ADD UNIQUE KEY `email` (`email`),
  ADD KEY `staff_fk0` (`registration_no`);
...
--
-- Indexes for table `vacant_bed_log`
--
ALTER TABLE `vacant_bed_log`
  ADD PRIMARY KEY (`registration_no`,`last_updated`);
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `amenity`
--
ALTER TABLE `amenity`
  ADD CONSTRAINT `amenity_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `blood_analytical_service`
--
ALTER TABLE `blood_analytical_service`
  ADD CONSTRAINT `blood_analytical_service_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `booking`
--
ALTER TABLE `booking`
  ADD CONSTRAINT `booking_fk0` FOREIGN KEY (`mobile_no`) REFERENCES `user` (`mobile_no`),
  ADD CONSTRAINT `booking_fk1` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `capacity`
--
ALTER TABLE `capacity`
  ADD CONSTRAINT `capacity_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `diagnostic_imaging_service`
--
ALTER TABLE `diagnostic_imaging_service`
  ADD CONSTRAINT `diagnostic_imaging_service_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `doctor`
--
ALTER TABLE `doctor`
  ADD CONSTRAINT `doctor_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `general_service`
--
ALTER TABLE `general_service`
  ADD CONSTRAINT `general_service_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `log`
--
ALTER TABLE `log`
  ADD CONSTRAINT `log_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`),
  ADD CONSTRAINT `log_fk1` FOREIGN KEY (`mobile_no`) REFERENCES `staff` (`mobile_no`);

--
-- Constraints for table `schedule`
--
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_fk0` FOREIGN KEY (`id`) REFERENCES `doctor` (`id`);

--
-- Constraints for table `staff`
--
ALTER TABLE `staff`
  ADD CONSTRAINT `staff_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);

--
-- Constraints for table `vacant_bed_log`
--
ALTER TABLE `vacant_bed_log`
  ADD CONSTRAINT `vacant_bed_log_fk0` FOREIGN KEY (`registration_no`) REFERENCES `hospital` (`registration_no`);
COMMIT;
